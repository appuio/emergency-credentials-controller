...
import (
	...
	"github.com/appuio/emergency-credentials-controller/controllers"
...
func init() {
	...
	utilruntime.Must(emcv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a077a2c2.appuio.io",
	...
	if err = (&controllers.EmergencyAccountReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),

		Clock: realClock{},
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "EmergencyAccount")
		os.Exit(1)
	}
